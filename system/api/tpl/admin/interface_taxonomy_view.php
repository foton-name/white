...
<?php  foreach($data['no_section'] as $val){?>
<a href='/taxonomy/<?=$val['table'];?>' class='taxonomy_a ' target="_blank"><?=$val['name'];?></a>
...
?>
    <div class='top front-work'>
        <div class='el-items-css dop-el-menu' ids='0' table='<?=$table;?>' 'model'='taxonomy'>Добавить элемент</div><div class='form-dop el-items-css'></div>
        <div class='menu-item'>
        <?
