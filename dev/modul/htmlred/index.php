...
<link href="/dev/modul/htmlred/css/fontawesome-webfont.ttf" rel="stylesheet">
...
<div class='top front-work'>
    <div class='htmlred5'>
        ...
        <div class='panel1'>
            ...
            <div class='sh'>
                <select class='shs'>
                    ...
                    <?
                    foreach (glob($GLOBALS["foton_setting"]["path"] . "/dev/modul/htmlred/tpl/" . $GLOBALS['foton_setting']['sitedir'] . "/*") as $filename) {
            ...
            <input type='button' class='upfoto' path='/dev/modul/htmlred/filest/<?= $GLOBALS['foton_setting']['sitedir']; ?>/'
                   path2='<?= $GLOBALS['foton_setting']['path']; ?>' value='Загрузить'>
            <div class='pthoto-block'>
                <?
                foreach (glob($GLOBALS["foton_setting"]["path"] . "/dev/modul/htmlred/filest/" . $GLOBALS['foton_setting']['sitedir'] . "/*") as $filename) {
                    echo '<img src="/dev/modul/htmlred/filest/' . $GLOBALS['foton_setting']['sitedir'] . '/' . basename($filename) . '" style="width:100%;" alt="Удаление при двойном нажатии" title="Удаление при двойном нажатии">';
                }
                ?>
            </div>
        </div>
        ...
        <div class='panel2'>
            ...
            <p class="p-rem"><input type="checkbox" name="compression" class="compression"> Сжать css/без font-awesome</p>
